...
def write_log(output_dir: Path, context: Dict[str, Any]) -> None:
    ...
    lines = [
        ...
        "",
        bullets(context.get("unverified_inferences", []), user_language),
        "",
        ...
        "## Protocol deviations",
        "",
        bullets(context.get("protocol_deviations", []), user_language),
        "",
        ...
        "",
        bullets(context.get("human_decisions_required", []), user_language),
        "",
        ...
        "## Next safe action",
        "",
        context.get("next_safe_action", tr(user_language, "none")),
        "",
    ]
